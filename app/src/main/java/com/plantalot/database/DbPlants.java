...
//				setColors(activity);  // manuale
    ...
    public static boolean hasDefaultImage(String ortaggio) {
        return (iconFiles.get(ortaggio) == null || iconFiles.get(ortaggio) == 0 || iconFiles.get(ortaggio) == defaultImageId);
    }
